...
class Spider86sb(scrapy.Spider):
    ...
    def load_data(self,url):
        self.driver.get(url)
        sleep(1)
        title = self.driver.find_element_by_xpath('/html/body/section[2]/div[2]/div[1]/div[1]/div[2]/ul/li[1]/h1')
        image = self.driver.find_element_by_xpath('/html/body/section[2]/div[2]/div[1]/div[1]/div[1]/div[1]/img')
        print(title.text)
